...
public class FlyOutContainer extends LinearLayout {
	...
	// Layout Constants
	protected static final int menuMargin = 450;
	...
	public MenuState menuCurrentState = MenuState.CLOSED;
	...
	private static final int menuAnimationPollingInterval = 12;
	...
	protected void onAttachedToWindow() {
		...
		this.menu = this.getChildAt(0);//assumes the menu is the first child
		this.content = this.getChildAt(1);//assumes the content is the second child
