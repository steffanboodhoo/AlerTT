 ...
 * on 2014-10-16 at 06:18:32 UTC 
 * Modify at your own risk.
 */

package com.gcm.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * optional parameters, call the {@link AlertPeople#execute()} method to invoke the remote
   * operation.
   *
   * @param message
   * @param latitude
   ...
   * @return the request
   */
  public AlertPeople alertPeople(java.lang.String message, java.lang.Double latitude, java.lang.Double longitude) throws java.io.IOException {
    AlertPeople result = new AlertPeople(message, latitude, longitude);
    initialize(result);
    return result;
  }

  public class AlertPeople extends DeviceinfoendpointRequest<com.gcm.deviceinfoendpoint.model.StringCollection> {

    private static final String REST_PATH = "alertPeople/{message}/{latitude}/{longitude}";
     ...
     * @since 1.13
     */
    protected AlertPeople(java.lang.String message, java.lang.Double latitude, java.lang.Double longitude) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, null, com.gcm.deviceinfoendpoint.model.StringCollection.class);
  ...
  public class GetDeviceInfo extends DeviceinfoendpointRequest<com.gcm.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected GetDeviceInfo(java.lang.String id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.gcm.deviceinfoendpoint.model.DeviceInfo.class);
   ...
   * operation.
   *
   * @param content the {@link com.gcm.deviceinfoendpoint.model.DeviceInfo}
   * @return the request
   */
  public InsertDeviceInfo insertDeviceInfo(com.gcm.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    InsertDeviceInfo result = new InsertDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class InsertDeviceInfo extends DeviceinfoendpointRequest<com.gcm.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected InsertDeviceInfo(com.gcm.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, content, com.gcm.deviceinfoendpoint.model.DeviceInfo.class);
    }
   ...
   * @return the request
   */
  public UpdateDeviceInfo updateDeviceInfo(com.gcm.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    UpdateDeviceInfo result = new UpdateDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class UpdateDeviceInfo extends DeviceinfoendpointRequest<com.gcm.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected UpdateDeviceInfo(com.gcm.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, com.gcm.deviceinfoendpoint.model.DeviceInfo.class);
    }
